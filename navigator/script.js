...
/**
 * Navigator — Topics Toggle
 * Minimal, clean, DokuWiki‑friendly.
 */

document.addEventListener('DOMContentLoaded', function () {

    var toggle = document.getElementById('navigator__topics-toggle');
    var panel  = document.getElementById('navigator__topics-panel');
